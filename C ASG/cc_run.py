...
test_samples = {
    ...
    'Mozi': ['b9f23009ff836e3a368cd7adf701b6e7.bin', '567b30e6033bd831ef2190c5ad863ff3.bin', 'bc3382acc65d23955eb48132961a8221.bin'],
    ...
    'Xorddos': ['0aefb67c01a24d05351b093455203fa2.bin', '0bc90c333f08237475a08c7158aba345.bin', '07c070b717a23453a2b71c7582d6a928.bin', '7eba17d4ea5615e239c00e47d182e08a.bin']
}

for family_name in test_samples:
    # for s in test_samples[family_name]:
    #     build(family_name, s)
    [build(family_name, s) for s in test_samples[family_name]]